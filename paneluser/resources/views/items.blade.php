    ...
    <nav  class="navbar navbar-expand-lg fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{url('items')}}" id="productos">Productos</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            ...
            {{-- <p><strong style="color: #000"> Precio del producto:</strong>{{$item->precio}} <strong style="background-color: #000;color:#fff; border-radius:10px; padding:2px">15$u$ por kilo</strong></p>
            <br> --}}
      ...
      {{-- @endforelse
        ...
        @endsection --}}
          <div class="col-md-6">
            ...
            <br>
            <p style="color:#000;">Información:</p>
            <p style="font-size: 1.1rem">La naranja forma parte de la variedad de cítricos que se cultivan en Bolivia, pero déjanos decirte que este no es un dato menor, ya que es una de las frutas que más se producen en nuestro país.</p>
